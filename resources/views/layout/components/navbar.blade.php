 <nav class="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-4 sm:px-6 md:px-8 py-4 bg-[#fffbf7]">
     ...
     <a href="#mirim" class="relative group inline-flex items-center gap-1 text-xl sm:text-2xl font-[Inter]">
         ...
         <span class="absolute left-0 -bottom-2 w-full h-[2px] bg-orange-500 scale-x-0 origin-center transition-transform duration-300 ease-out group-hover:scale-x-100"></span>
     </a>
